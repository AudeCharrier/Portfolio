...
/* vraie version, ici commentée pour éviter les envois des tests par les utilisateurs

  // Si invalide, on empêche l’envoi
  if (!formulaireValide) {
    e.preventDefault();
  } // Si valide, Formspree s’en charge tout seul et redirige vers la page de validation Formspree
});
